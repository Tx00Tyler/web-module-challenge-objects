...
// createMenuItem('pizza', "7", "food");
// createMenuItem('coke', "2", "drink");
// createMenuItem('salad', "5", "appetizer");
...
export const burger = {
  ...
  discount: function(sale) {
    if (sale === "student" || sale === "teacher"){
      let num1 = this.price;
      let num2 =  .75;
      var finalPrice = num1 * num2;
      return finalPrice;
    }  else {
      let num1 = this.price;
      let num2 =  25/100;
...
*/
reviews.push({name: "Tyler", rating: 7, feedback: "Really loved the place"})
console.log(reviews); 
